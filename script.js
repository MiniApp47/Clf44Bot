...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const contactLinks = [
        {
            name: 'CANAL POTATO 🥔',
            url: 'https://duanym138.org/clff44',
            id: 'potato-canal',
        ...
        {
            name: 'CANAL LUFFA 🌐',
            url: 'https://callup.luffa.im/c/PAQUiNJTLrC',
            id: 'luffa-canal',
            className: 'luffa', // Garde le style Marron/Doré Potato
            text: "CANAL LUFFA 🌐"
        },
        {
            name: 'CONTACT TELEGRAM 🔌',
            url: 'https://t.me/CLF_44',
            id: 'telegram-main',
            className: 'telegram', // Garde le style Marron/Doré Potato
            text: "CONTACT TELEGRAM 🔌"
        },
        {
            name: 'CONTACT POTATO 🥔',
            url: 'https://dympt.org/00021da08c0340e3335f6b00d58932575ff',
            id: 'potato-main',
            className: 'potato', // Garde le style Marron/Doré Potato
            text: "CONTACT POTATO 🥔"
        },
        {
            name: 'CONTACT LUFFA 🌐',
            url: 'https://callup.luffa.im/p/GaiKL39CCAL',
            id: 'luffa-main',
            className: 'luffa', // Garde le style Marron/Doré Potato
            text: "CONTACT LUFFA 🌐"
        },
        {
            name: 'INSTA\'BIO 🔗',
            url: 'https://instabio.cc/CLF44nantes',
            id: 'instagram',
            ...
            products: [
                {
                    ...
                    video: 'VideoSnow.mp4',
                    description: 'POUR NOS SKIEURS ⛷️ \n\n Provenance : BOLIVIE 🇧🇴 \n Qualité inédite 💎 \n\n QUANTITÉ ET QUALITÉ GARANTIE ✅',
                    tarifs: [
        ...
        // ============================================================
        {
            ...
            farms: [
                // 1. ULTRA MOUSS 🇲🇦
                {
                    id: 'ULTRA_MOUSS',
                    name: 'ULTRA MOUSS 🇲🇦',
                    image: 'UltraMouss.png',
                    badgeText: 'TOP QUALITÉ',
                    products: [] // Ajoute tes produits ici
                },
                // 2. FILTRER 90U 🇲🇦
                {
                    id: 'FILTRE_90U',
                ...
                // 4. FROZEN SIFT 🇲🇦
                {
                    ...
                    products: [
                        ...
                        },
                        {
                            ...
                            description: '',
                            jars: [
                                { name: 'GRAPE GAZ', emoji: '🍇', colorClass: 'style-grappe' },
                                { name: 'LAVA CAKE', emoji: '🍰', colorClass: 'style-passion' },
                                { name: 'MANDARINA COOKIEs', emoji: '🍊', colorClass: 'style-lampo' },
                                { name: 'PASSION FRUIT’z', emoji: '🍈', colorClass: 'style-melon' },
                            ],
                            tarifs: [
                                { weight: '5G', price: 70.00 },
                                { weight: '10G', price: 120.00 },
                    ...
                    products: [
                        {
                            ...
                            description: '',
                            variantTitle: 'Saveurs Olive 🫒 :', 
                            jars: [
                                { name: '𝐅𝐫𝐨𝐛𝐢𝐝𝐝𝐞𝐧 𝐟𝐫𝐮𝐢𝐭𝐬', emoji: '🍇', colorClass: 'style-red' },
                                { name: '𝐚𝐥𝐢𝐞𝐧 𝐣𝐞𝐬𝐬𝐲', emoji: '👽', colorClass: 'style-gmo' },
                            ],
                            tarifs: [
                        ...
                        },
                        {
                            ...
                            promoEligible: true,
                            type: 'StaticSift',
                            image: 'ProductMelow.png',
                            video: 'VideoMelow.mov',
                            description: '𝐏𝐋𝐀𝐐𝐔𝐄 𝐃𝐎𝐔𝐁𝐋𝐄 𝐒𝐓𝐀𝐓𝐈𝐂',
                            tarifs: [
                                { weight: '5G', price: 80.00 },
                                { weight: '10G', price: 150.00 },
                                { weight: '20G', price: 290.00 },
                 ...
                 products: [
                    {
                        ...
                        image: 'ProductSift.png',
                        video: 'VideoSift.mp4',
                        description: 'QUALITÉ ET QUANTITÉ RESPECTER ✅',

                        // 👇 NOUVELLE STRUCTURE
                        variantTitle: 'Saveurs Frozen ❄️ :',
                        jars: [
                            { name: 'PAPAYA BOMB', emoji: '🥭', colorClass: 'style-passion' },
                            { name: 'BARY PAYTON', emoji: '🛢️🍬', colorClass: 'style-red' },
                            { name: 'COOKIE CASKET', emoji: '🍪', colorClass: 'style-tangier' },
                            { name: 'KUSH MINTZ', emoji: '❄️', colorClass: 'style-melon' },
                            { name: 'TROPICANA BURGEUR', emoji: '🍔', colorClass: 'style-red' },
...
/*                             { name: 'POISON', emoji: '💀', colorClass: 'style-purple' },
                    ...
                    products: [
                        {
                            ...
                            tarifs: [
                                ...
                                { weight: '200G', price: 780.00 },
                                { weight: '500G', price: 1750.00 },
                                { weight: '1 kilos', price: 3200.00 },
                            ]
                        }  
                    ]
                },
                    ...
                    products: [
                        {
                            ...
                            promoEligible: true,
                            type: 'CaliUs',
                            image: 'ProductMarker.png',
                            video: 'VideoMarker.mov',
                            description: '',
                            tarifs: [
                                ...
                                { weight: '100G', price: 670.00 },
                                { weight: '500G', price: 3000.00 },
                            ]
                        }  
                    ]
                },
                // 5. WEED USA TOP SHELF 🇺🇸
                {
                    id: 'WEED_USA_TOP_SHELF',
                    name: 'WEED USA TOP SHELF 🇺🇸',
                    image: 'TopShelf.png',
                    badgeText: 'EXCLUSIF ⭐',
                    products: []
                }
    ...
    function renderHomePage() {
        ...
        if (currentView === 'categories') {
            ...
            align-items: center;
            background: linear-gradient(182deg, #71d2f2, transparent);
                        border-radius: 10px;`;
...
if (target.closest('#confirm-order-button')) {
    ...
    // 1. TON NOM D'UTILISATEUR TELEGRAM (sans le @)
    const telegramUsername = 'CLF_44'; 
    
    // 2. Préparation du message (récupère ta fonction existante)
    let message = formatOrderMessage();
    
    // 3. Encodage du message
    const encodedMessage = encodeURIComponent(message);
    
    // 4. Création du lien de partage direct (ou lien vers ton profil)
    // On utilise t.me pour ouvrir une discussion avec le message pré-rempli
    const telegramUrl = `https://t.me/${telegramUsername}?text=${encodedMessage}`;

    // 5. Ouverture via l'API Telegram WebApp
